...
%\newpage
\newdate{date}{27}{04}{2015}
\title{Curvature Estimation Algorithm's Implementation}
\author{NGUYEN Quang Anh, REBMANN Guillaume}
...
\input{project/DGTalPresentation.tex}

\input{project/CCAlgorithm.tex}

\input{project/BCCAlgorithm.tex}

\input{project/OpenCL.tex}

\input{project/Difficulties.tex}
